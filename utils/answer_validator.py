...
def validate_response(model_output: str, expected: str, dataset_type: str) -> bool:
    """
    Validates the response of a model by comparing its output to the expected answer
    based on the specified dataset type.

    Args:
        model_output (str): The output generated by the language model to be validated.
        expected (str): The expected answer or the reference dataset value to validate against.
        dataset_type (str): The type of dataset being used for validation. Determines the
            parsing logic.

    Returns:
        bool: True if the model's response is validated as correct for the specified dataset
